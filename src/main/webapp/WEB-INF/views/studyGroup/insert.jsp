		...
		<div class="form-group studygroupUpdate">
			...
			<form action="/studyGroup/insert" method="post" enctype="multipart/form-data">
				<input type="hidden" name="${_csrf.parameterName}"
					value="${_csrf.token}" /> 그룹 이름 : <input type="text"
					name="studygroup_name"> <br> 그룹 소개 : <input
					type="text" name="studygroup_info"> <br> <select
					name="studygroup_location">
					<option value="서울">서울</option>
					<option value="부산">부산</option>
					<option value="대구">대구</option>
				</select> 그룹 지역 : <br> 최대 인원 : <input type="text" name="max_user_number">
				<br> 대면여부 : <input type="radio" name="isface" value="Y">대면
