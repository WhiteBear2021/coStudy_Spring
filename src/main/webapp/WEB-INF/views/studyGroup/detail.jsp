...
<%--                         <div class="form-group col-md-2">
                        ...
                        <br>
                        <form action="/studyGroup/apply" method="post">
                        <input type="hidden" name="user_no" value="${sessionScope.user.user_no }">
                        <input type="hidden" name="studygroup_no" value="${studygroup.studygroup_no }">
                        
                           <button type="submit" class="button type1">신청하기</button>
                           <!-- <a href="/studyGroup/list"><button type="reset" class="button type1">취소</button></a> -->
