...
<body>
										...
										<div class="card-body">
											<div class="shop__sidebar__categories">
												<ul class="nice-scroll">
													<li><a href="/studyGroup/list?category_no=1">IT (${total1 })</a></li>
													<li><a href="/studyGroup/list?category_no=2">외국어 (${total2 })</a></li>
													<li><a href="/studyGroup/list?category_no=3">취업 (${total3 })</a></li>
													<li><a href="/studyGroup/list?category_no=4">자격증 (${total4 })</a></li>
													<li><a href="/studyGroup/list?category_no=5">전공 (${total5 })</a></li>
												</ul>
											</div>
										</div>
									</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-6">
								<div class="product__item">
									<div class="product__item__pic set-bg">
										<img src="${studyGroup.thumbimg}"
											style="width: 262px; height: 262px;">
									</div>
									<div class="product__item__text">
										<a
											href="/studyGroup/detail?studygroup_no=${studyGroup.studygroup_no }"
											class="add-cart">+more</a>
									...
									<h5>
										<a
											href="/studyGroup/detail?studygroup_no=${studyGroup.studygroup_no }">${studyGroup.studygroup_name }</a>
									</h5>
								</div>
							</div>
						</c:forEach>
	...
	<nav aria-label="...">
		<ul class="pagination"
			style="clear: right; width: 500px; margin: auto">
			<!--이전  -->
