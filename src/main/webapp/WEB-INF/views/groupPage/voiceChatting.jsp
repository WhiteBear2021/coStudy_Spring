...
<!-- Specific version -->
<script
	src="https://cdn.jsdelivr.net/npm/@remotemonster/sdk@2.0.8/remon.min.js"></script>
<script>
const config = {
  credential: {
    serviceId: '5122057a-631a-4ba4-8111-7b3457480d7d', 
    key: '16ea412d4c2a989fc877392d83809e561ce33fb2ad200ec85ddd924ae1e6faeb'
  }
}
					...
					<div class="row">
						...
						<div class="col-xl-8 col-lg-7">
							<div class="card shadow mb-4">
								...
								<div
									class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">Local Audio
									</h6>
								</div>
								<!-- Card Body -->
								<div class="card-body">
