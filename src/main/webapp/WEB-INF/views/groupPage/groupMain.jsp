	...
	<div id="wrapper">
				...
				<div class="col-lg-2" id="sidelist">
					<div class="naccs">
						<div class="menu" style="margin-right: 50px;">
							...
							<button class="light" id="class_timer"
         ...
         type="hidden" name="studyGroup_no" value="1"> -->
					<div id="background-body">
												...
												<div class="input-group">
													...
													<form action="insertGroupReply" method="post">
														<input type="hidden" name="studygroup_no"
															...
															type="hidden" class="form__field"
															name="group_reply_writer"
														...
														<div class="post-footer">
															...
															<c:forEach var="relist" items="${relist }">
																<c:if
																	test="${board.page_board_no==relist.page_board_no }">

																	<ul class="comments-list">
																		<li class="comment"><a class="pull-left" href="#">
																				<img class="avatar" src="../img/manager.png"
																				alt="avatar">
																		</a>
						...
						<form action="insert" method="post">
							<div id="write">
								<input type="hidden" name="studygroup_no"
									value="${studygroup_no}"> <input
									id="page_board_content" type="text" name="page_board_content"
									style="width: 600px; height: 70px;">
								<button id="button" type="submit"
									style="width: 70px; height: 70px;">작성</button>
								>>>>>>> branch 'JW' of
								https://github.com/WhiteBear2021/coStudy_Spring.git
							</div>
					</div>
				</div>
		</div>
		<div class="col-lg-2" id="sidelist">
			...
			<div class="naccs">
				...
				<button class="menu" style="margin-right: 50px;"
					onclick="location.href='/groupPage/fileList?studygroup_no=${studygroup_no }'">
					파일 보관함</button>
...
<<<<<<< HEAD
	...
	/* 	$('#file').on('click', function(callback) {
	 console.log("file 클릭함");
	 $('#change').hide();
	 $('#insert').hide(); 
	 $.ajax({
	 url : '/groupPage/fileList',
	 type : 'POST',
	 dataType : 'json',
	 //data: {studygroup_no: ${studygroup_no} },
	 success : function() {
	 let html2 ="";
...
=======
>>>>>>> branch 'JW' of https://github.com/WhiteBear2021/coStudy_Spring.git
</script>
</body>
</html>