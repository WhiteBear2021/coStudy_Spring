					...
					<div class="row">
						<div class="form-group">
							<form action="studyDiaryUpdate" method="post">
								...
								<input type="hidden" name="studyNote_no" value="${diary.studyNote_no}">			
								</label><br><br>
								<label>
								<label>
								키워드 : <input type="text" name="studyNote_keyword" style="width:300%;" value="${diary.studyNote_keyword}">
								</label><br><br>
								<label>
								제목 : <input type="text" name="studyNote_title" style="width:300%;" value="${diary.studyNote_title}">
								</label><br><br>
								
								<label>
								글내용 :
								<textarea class="form-control" rows="10" cols="100" name="studyNote_content">${diary.studyNote_content}</textarea> 
								</label><br><br>
								<label>
