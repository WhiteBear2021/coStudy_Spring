		...
		<div class="col-3" style="margin-top: 70px;">
			...
			<div id='external-events'>
				...
				<p>
					<input type='checkbox' id='drop-remove' /> <label
						for='drop-remove'>Drop 후 제거</label>
				</p>
			</div>
			...
			<div class='demo-topbar'>
				...
				<button class="btn btn-primary btn-lg" id="saveBtn"
					style="margin-top: 5px;">전체 저장</button>
			</div>
		</div>
		<div class="col-9">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label">일정 내용</label> <input type="text"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">종일 여부</label> <input
											type="checkbox" name="allDay" id="allDay"><br>
								...
								<div class='col-md-6'>
									<div class="form-group">
										...
										<br> <label class="control-label">종료일</label>
