...
public class QnaController {
	...
	public void charts(Model model) {
		...
		List<Integer> lists = service.charts();
...
/*	 @RequestMapping(value = "/charts", method = RequestMethod.GET)
	  	public String home(Locale locale, Model model)throws Exception {
	  		...
	  		int womenCount = service.charts2();
	  		int menCount = service.charts2();
...
*/
	...
	@ResponseBody
	public String ajax_addComment3(@RequestParam("qna_no") int qna_no, @RequestParam("qna_content") String qna_content,
	...
	public String manager_detail4(@RequestParam("qna_no") int qna_no, @RequestParam("qna_content") String qna_content,
