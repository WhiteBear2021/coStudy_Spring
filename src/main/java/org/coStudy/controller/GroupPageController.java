...
public class GroupPageController {
   ...
   @ResponseBody
   public ResponseEntity<List<GroupFileVO>> fileUpload(@RequestParam("studygroup_no") int studygroup_no){
	   return new ResponseEntity<>(groupPage_service.fileList(studygroup_no), HttpStatus.OK);
   }
   */
   @GetMapping("/fileList")
